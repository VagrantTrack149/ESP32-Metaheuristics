...
void setup() {
    ...
    GeneticAlgorithm ga(limites, errorCirculo, TAM_POBLACION);

    Serial.println("Ajustando un circulo inclinado con GA...");
    ...
    Serial.println("\nResultado final:");
    Serial.printf("Fitness: %.6f\n", ga.mejor().fitness);
    imprimirCoordenadas(ga.mejor().posicion);
}
